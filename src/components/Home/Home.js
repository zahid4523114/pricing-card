...
const Home = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-[#293356] bg-[#fafbff]">
      <div className="card-container dark:bg-[#cdd7ee] w-full">
        ...
        <div className="card absolute top-1/12 left-1/2 lg:mt-60 mt-48 lg:w-2/5 md:w-2/5 w-4/5  bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="flex justify-between items-center ">
              ...
              <div>
                <p>
                  Yearly Billing
                  <span className="bg-[#feece7] p-1 ml-1 rounded-full">
                    <span className="text-[#ff8c66] text-xs">25%</span>
